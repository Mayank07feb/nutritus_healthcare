        ...
        if (typeof Splide === 'function') {
            ...
            if (mainCarousel && thumbsCarousel) {
                const main = new Splide(mainCarousel, {
                    type: 'fade', rewind: true, perPage: 1, autoplay: false,
                ...
                const thumbs = new Splide(thumbsCarousel, {
                    gap: 10, perPage: 3, rewind: true, height: '120px', autoWidth: true, pagination: false, isNavigation: true,
                    direction: dir,
                    breakpoints: { 1200: { perPage: 2 }, 768: { perPage: 2 }, 480: { perPage: 1 } }
                });
            ...
            // Five Thumbnail Carousel
            const fivemainCarousel = document.querySelector('#five-carousel');
            const fivethumbsCarousel = document.querySelector('#five-thumbnail-carousel');

            if (fivemainCarousel && fivethumbsCarousel) {
                const fivemain = new Splide(fivemainCarousel, {
                    type: 'fade', rewind: true, perPage: 1, autoplay: false,
                    pauseOnHover: true, interval: 5000, direction: dir,
                    arrows: false, pagination: false, speed: 1000
                });

                const fivethumbs = new Splide(fivethumbsCarousel, {
                    gap: 20, perPage: 3, rewind: true, autoWidth: false, pagination: false, isNavigation: true,
                    direction: dir,
                    breakpoints: { 1200: { perPage: 2 }, 768: { perPage: 2 }, 480: { perPage: 1 } }
                });

                fivemain.sync(fivethumbs).mount();
                fivethumbs.mount();
            }
        }
